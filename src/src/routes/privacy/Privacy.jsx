...
// Data
import { pagename, owner } from "../../assets/data/data.json"
...
export default () => {
    ...
    return <>
        ...
        <main className={styles.main}>
            ...
            <p className={styles.text}><b>2.</b> El acceso al sitio web de <b>{pagename}</b> es gratuito. Todo el contenido es propiedad intelectual de {owner}. Cualquier utilización de los mismos contraria a las normas en materia de propiedad intelectual será perseguida con arreglo a la legislación vigente.</p>
            ...
            <p className={styles.text}>El interesado podrá ejercitar sus derechos mediante comunicación por escrito dirigida a {pagename} en la dirección indicada al inicio o a la dirección de correo electrónico informada en el pie de página.</p>
            ...
            <p className={styles.text}>{pagename} le informa que tiene implantadas las medidas de seguridad de índole técnica y organizativas necesarias para garantizar la seguridad de sus datos de carácter personal y evitar su alteración, pérdida y tratamiento y/o acceso no autorizado, habida cuenta del estado de la tecnología, la naturaleza de los datos almacenados y los riesgos a que están expuestos, ya provengan de la acción humana o del medio físico o natural. Así, {pagename} ha establecido medidas adicionales en orden a reforzar la confidencialidad e integridad de la información en la organización. No obstante, el usuario debe ser consciente de que las medidas de seguridad en Internet no son inexpugnables y enteramente fiables y que {pagename} no puede garantizar la inexistencia de virus u otros elementos que pudieran producir alteraciones en los sistemas informáticos (software y hardware) del usuario.</p>
            <p className={styles.text}>{pagename} continuamente mantiene la supervisión, control y evaluación de los procesos para asegurar el respeto a la privacidad de los datos.</p>
            ...
            <p className={styles.text}>No respondemos de aquellos datos de menores que sin poder conocer {pagename} este hecho se haya facilitado sin el consentimiento de los padres o tutores.</p>

            <p className={styles.article}>6. MODIFICACIÓN DE LA POLÍTICA DE PRIVACIDAD</p>
            <p className={styles.text}>{pagename} se reserva el derecho a modificar su Política de Privacidad. Cualquier modificación de la Política de Privacidad será publicada, antes de su efectiva aplicación. El uso del Web después de dichos cambios, implicará la aceptación de éstos.</p>
